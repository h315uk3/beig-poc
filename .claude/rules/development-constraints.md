...
### 1. No Speculation
Never propose implementations based on assumptions. Always verify with official documentation, source code, or latest information.
...
- Built-in modules: pathlib, json, math, re, datetime, etc.
