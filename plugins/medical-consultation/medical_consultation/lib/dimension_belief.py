#!/usr/bin/env python3
"""
Belief state management for symptom dimensions.
...
Skills:
- /medical-consultation:entropy
- /medical-consultation:bayesian-update
- /medical-consultation:information-gain
...
class HypothesisSet:
    ...
    - /medical-consultation:entropy for entropy calculation
    - /medical-consultation:bayesian-update for posterior updating
    - /medical-consultation:information-gain for information gain calculation
    ...
    # get_confidence() removed - use /medical-consultation:entropy skill
...
def main():
    ...
    if len(sys.argv) < min_argc:
        ...
        print("  python -m medical_consultation.cli.session compute-entropy")
        print("  python -m medical_consultation.cli.session bayesian-update")
        sys.exit(1)
