...
Skills:
- /medical-consultation:eig-calculation
- /medical-consultation:question-clarity
- /medical-consultation:question-importance
...
class QuestionContext(TypedDict):
    ...
    to call medical-consultation's reward calculator without knowing internal implementation.
...
#
# 1. Question Clarity:
#    - Invoke: /medical-consultation:question-clarity
#    - Input: question text
#    - Output: clarity score [0.0, 1.0]
#
# 2. Question Importance:
#    - Invoke: /medical-consultation:question-importance
#    - Input: question text
#    - Output: importance score [0.0, 1.0]
#
# 3. Expected Information Gain (EIG):
#    - Invoke: /medical-consultation:eig-calculation
#    - Input: question, current_beliefs, answer_templates
#    - Uses: /medical-consultation:entropy, /medical-consultation:bayesian-update internally
#    - Output: EIG in bits
#
# 4. Hybrid Reward:
...
def main():
    ...
    print("  - /medical-consultation:question-clarity")
    print("  - /medical-consultation:question-importance")
    print("  - /medical-consultation:eig-calculation")
    print(
        "\nFor testing, run: python -m medical_consultation.lib.question_reward_calculator --test"
    )
