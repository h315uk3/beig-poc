#!/usr/bin/env python3
"""
Question Feedback Manager for medical-consultation plugin
...
class WithMeConfig:
    """Immutable configuration for medical-consultation plugin"""

    workspace_root: Path
    claude_dir: Path
    medical_consultation_dir: Path
    feedback_file: Path
    ...
    def from_environment(cls):
        ...
        Examples:
            ...
            >>> medical_consultation_dir = claude_dir / "medical_consultation"
            >>> medical_consultation_dir.mkdir(parents=True)
            >>> # Test direct instantiation (demonstrates structure)
            >>> config = WithMeConfig(
            ...     workspace_root=temp_root,
            ...     claude_dir=claude_dir,
            ...     medical_consultation_dir=medical_consultation_dir,
            ...     feedback_file=medical_consultation_dir / "question_feedback.json",
            ... )
