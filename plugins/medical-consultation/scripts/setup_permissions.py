#!/usr/bin/env python3
"""
Setup permissions for medical-consultation plugin.
...
- 1 Skill (symptom-analysis for post-session analysis)
...
# Required permissions for medical-consultation plugin
REQUIRED_PERMISSIONS = [
    # Environment setup
    'Bash(export PYTHONPATH="${CLAUDE_PLUGIN_ROOT}")',
    # CLI commands
    "Bash(python3 -m medical_consultation.cli.session init*)",
    "Bash(python3 -m medical_consultation.cli.session next-question*)",
    "Bash(python3 -m medical_consultation.cli.session evaluate-question*)",
    "Bash(python3 -m medical_consultation.cli.session update-with-computation*)",
    "Bash(python3 -m medical_consultation.cli.session status*)",
    "Bash(python3 -m medical_consultation.cli.session complete*)",
    # Skills (for post-session analysis only)
    "Skill(medical-consultation:symptom-analysis)",
    # Read permissions for session data
    "Read(.claude/medical_consultation/sessions/*.json)",
]
