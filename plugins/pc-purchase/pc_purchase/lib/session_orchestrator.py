...
from pc_purchase.lib.dimension_belief import (
    HypothesisSet,
    create_default_dimension_beliefs,
)
from pc_purchase.lib.question_feedback_manager import QuestionFeedbackManager
...
class SessionOrchestrator:
    ...
    def __init__(
        ...
        if config_path is None:
            # Path: pc_purchase/lib/session_orchestrator.py → plugins/pc-purchase/
...
def main():
    ...
    if len(sys.argv) < min_argc:
        print("Usage: python3 -m pc_purchase.lib.session_orchestrator <command>")
        print("\nCommands:")
