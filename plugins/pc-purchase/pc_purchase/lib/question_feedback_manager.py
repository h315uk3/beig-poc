#!/usr/bin/env python3
"""
Question Feedback Manager for pc-purchase plugin
...
class WithMeConfig:
    """Immutable configuration for pc-purchase plugin"""

    workspace_root: Path
    claude_dir: Path
    pc_purchase_dir: Path
    feedback_file: Path
    ...
    def from_environment(cls):
        ...
        Examples:
            ...
            >>> pc_purchase_dir = claude_dir / "pc_purchase"
            >>> pc_purchase_dir.mkdir(parents=True)
            >>> # Test direct instantiation (demonstrates structure)
            >>> config = WithMeConfig(
            ...     workspace_root=temp_root,
            ...     claude_dir=claude_dir,
            ...     pc_purchase_dir=pc_purchase_dir,
            ...     feedback_file=pc_purchase_dir / "question_feedback.json",
            ... )
