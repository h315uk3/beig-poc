...
Skills:
- /pc-purchase:eig-calculation
- /pc-purchase:question-clarity
- /pc-purchase:question-importance
...
class QuestionContext(TypedDict):
    ...
    to call pc-purchase's reward calculator without knowing internal implementation.
...
#
# 1. Question Clarity:
#    - Invoke: /pc-purchase:question-clarity
#    - Input: question text
#    - Output: clarity score [0.0, 1.0]
#
# 2. Question Importance:
#    - Invoke: /pc-purchase:question-importance
#    - Input: question text
#    - Output: importance score [0.0, 1.0]
#
# 3. Expected Information Gain (EIG):
#    - Invoke: /pc-purchase:eig-calculation
#    - Input: question, current_beliefs, answer_templates
#    - Uses: /pc-purchase:entropy, /pc-purchase:bayesian-update internally
#    - Output: EIG in bits
#
# 4. Hybrid Reward:
...
def main():
    ...
    print("  - /pc-purchase:question-clarity")
    print("  - /pc-purchase:question-importance")
    print("  - /pc-purchase:eig-calculation")
    print(
        "\nFor testing, run: python -m pc_purchase.lib.question_reward_calculator --test"
    )
