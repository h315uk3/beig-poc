...
Skills:
- /pc-purchase:entropy
- /pc-purchase:bayesian-update
- /pc-purchase:information-gain
...
class HypothesisSet:
    ...
    - /pc-purchase:entropy for entropy calculation
    - /pc-purchase:bayesian-update for posterior updating
    - /pc-purchase:information-gain for information gain calculation
    ...
    # get_confidence() removed - use /pc-purchase:entropy skill
...
def main():
    ...
    if len(sys.argv) < min_argc:
        ...
        print("  python -m pc_purchase.cli.session compute-entropy")
        print("  python -m pc_purchase.cli.session bayesian-update")
        sys.exit(1)
