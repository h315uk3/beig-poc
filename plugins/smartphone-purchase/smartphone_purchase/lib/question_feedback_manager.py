...
class WithMeConfig:
    ...
    def from_environment(cls):
        ...
        Examples:
            ...
            >>> smartphone_purchase_dir = claude_dir / "smartphone_purchase"
            >>> smartphone_purchase_dir.mkdir(parents=True)
            >>> # Test direct instantiation (demonstrates structure)
            >>> config = WithMeConfig(
            ...     workspace_root=temp_root,
            ...     claude_dir=claude_dir,
            ...     smartphone_purchase_dir=smartphone_purchase_dir,
            ...     feedback_file=smartphone_purchase_dir / "question_feedback.json",
            ... )
