#!/usr/bin/env python3
"""
Setup permissions for smartphone-purchase plugin.
...
- 1 Skill (smartphone-purchase-analysis for post-session analysis)
...
# Required permissions for smartphone-purchase plugin
REQUIRED_PERMISSIONS = [
    # Environment setup
    'Bash(export PYTHONPATH="${CLAUDE_PLUGIN_ROOT}")',
    # CLI commands
    "Bash(python3 -m smartphone_purchase.cli.session init*)",
    "Bash(python3 -m smartphone_purchase.cli.session next-question*)",
    "Bash(python3 -m smartphone_purchase.cli.session evaluate-question*)",
    "Bash(python3 -m smartphone_purchase.cli.session update-with-computation*)",
    "Bash(python3 -m smartphone_purchase.cli.session status*)",
    "Bash(python3 -m smartphone_purchase.cli.session complete*)",
    # Skills (for post-session analysis only)
    "Skill(smartphone-purchase:smartphone-purchase-analysis)",
    # Read permissions for session data
    "Read(.claude/smartphone_purchase/sessions/*.json)",
]
