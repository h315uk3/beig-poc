...
class WithMeConfig:
    ...
    def from_environment(cls):
        ...
        Examples:
            ...
            >>> smartphone_repair_dir = claude_dir / "smartphone_repair"
            >>> smartphone_repair_dir.mkdir(parents=True)
            >>> # Test direct instantiation (demonstrates structure)
            >>> config = WithMeConfig(
            ...     workspace_root=temp_root,
            ...     claude_dir=claude_dir,
            ...     smartphone_repair_dir=smartphone_repair_dir,
            ...     feedback_file=smartphone_repair_dir / "question_feedback.json",
            ... )
