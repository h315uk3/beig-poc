#!/usr/bin/env python3
"""
Setup permissions for crop-planning plugin.
...
- 1 Skill (analysis for post-session analysis)
...
# Required permissions for crop-planning plugin
REQUIRED_PERMISSIONS = [
    # Environment setup
    'Bash(export PYTHONPATH="${CLAUDE_PLUGIN_ROOT}")',
    # CLI commands
    "Bash(python3 -m crop_planning.cli.session init*)",
    "Bash(python3 -m crop_planning.cli.session next-question*)",
    "Bash(python3 -m crop_planning.cli.session evaluate-question*)",
    "Bash(python3 -m crop_planning.cli.session update-with-computation*)",
    "Bash(python3 -m crop_planning.cli.session status*)",
    "Bash(python3 -m crop_planning.cli.session complete*)",
    # Skills (for post-session analysis only)
    "Skill(crop-planning:requirement-analysis)",
    # Read permissions for session data
    "Read(.claude/crop_planning/sessions/*.json)",
]
