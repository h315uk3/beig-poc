#!/usr/bin/env python3
"""
Question Feedback Manager for crop-planning plugin
...
class WithMeConfig:
    """Immutable configuration for crop-planning plugin"""

    workspace_root: Path
    claude_dir: Path
    crop_planning_dir: Path
    feedback_file: Path
    ...
    def from_environment(cls):
        ...
        Examples:
            ...
            >>> crop_planning_dir = claude_dir / "crop_planning"
            >>> crop_planning_dir.mkdir(parents=True)
            >>> # Test direct instantiation (demonstrates structure)
            >>> config = WithMeConfig(
            ...     workspace_root=temp_root,
            ...     claude_dir=claude_dir,
            ...     crop_planning_dir=crop_planning_dir,
            ...     feedback_file=crop_planning_dir / "question_feedback.json",
            ... )
