...
from crop_planning.lib.dimension_belief import (
    HypothesisSet,
    create_default_dimension_beliefs,
)
from crop_planning.lib.question_feedback_manager import QuestionFeedbackManager
...
class SessionOrchestrator:
    ...
    def __init__(
        ...
        if config_path is None:
            # Path: crop_planning/lib/session_orchestrator.py → plugins/crop-planning/
...
def main():
    ...
    if len(sys.argv) < min_argc:
        print("Usage: python3 -m crop_planning.lib.session_orchestrator <command>")
        print("\nCommands:")
