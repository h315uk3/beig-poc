...
Skills:
- /crop-planning:entropy
- /crop-planning:bayesian-update
- /crop-planning:information-gain
...
class HypothesisSet:
    ...
    - /crop-planning:entropy for entropy calculation
    - /crop-planning:bayesian-update for posterior updating
    - /crop-planning:information-gain for information gain calculation
    ...
    # get_confidence() removed - use /crop-planning:entropy skill
...
def main():
    ...
    if len(sys.argv) < min_argc:
        ...
        print("  python -m crop_planning.cli.session compute-entropy")
        print("  python -m crop_planning.cli.session bayesian-update")
        sys.exit(1)
