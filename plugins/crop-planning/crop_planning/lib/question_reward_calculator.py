...
Skills:
- /crop-planning:eig-calculation
- /crop-planning:question-clarity
- /crop-planning:question-importance
...
class QuestionContext(TypedDict):
    ...
    to call crop-planning's reward calculator without knowing internal implementation.
...
#
# 1. Question Clarity:
#    - Invoke: /crop-planning:question-clarity
#    - Input: question text
#    - Output: clarity score [0.0, 1.0]
#
# 2. Question Importance:
#    - Invoke: /crop-planning:question-importance
#    - Input: question text
#    - Output: importance score [0.0, 1.0]
#
# 3. Expected Information Gain (EIG):
#    - Invoke: /crop-planning:eig-calculation
#    - Input: question, current_beliefs, answer_templates
#    - Uses: /crop-planning:entropy, /crop-planning:bayesian-update internally
#    - Output: EIG in bits
#
# 4. Hybrid Reward:
...
def main():
    ...
    print("  - /crop-planning:question-clarity")
    print("  - /crop-planning:question-importance")
    print("  - /crop-planning:eig-calculation")
    print(
        "\nFor testing, run: python -m crop_planning.lib.question_reward_calculator --test"
    )
